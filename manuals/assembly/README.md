...
### 2.3. 基板表面：表面実装品のはんだ付け

基板の**表面**へのはんだ付けからスタートです．まずは表面実装品です．

表面実装品でも挿入実装品でも **背の低い部品** からはんだ付けしていく事が鉄則です．以下の流れに沿って進めましょう．

#### 2.3.1. チップ抵抗・チップコンデンサのはんだ付けの仕方
...
### 2.5. 基板表面：挿入実装品のはんだ付け

再び基板の**表面**へのはんだ付けになります．今度は挿入実装品です．

挿入実装品でも **背の低い部品** からはんだ付けしていく事が鉄則です．以下の流れに沿って進めましょう．
